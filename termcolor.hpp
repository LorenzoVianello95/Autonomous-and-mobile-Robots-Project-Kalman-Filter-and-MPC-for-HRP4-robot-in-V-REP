...
// Pouya adding code to make this compatible with pre c++11 versions. 
// Not sure if this is a good idea but I think it wouldn't cause any problem as long as we use these methods with only std::cout and only.
#include <cstddef>
